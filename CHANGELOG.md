...
* Fixed Rust app building issue with new cargo-ledger
...
* AI powered code review. Uses Ledger's own [agent instructions](https://github.com/LedgerHQ/ledger-app-ai-instructions).
...
* Refactor UI to use a Webview (Svelte) instead of a Treeview.
